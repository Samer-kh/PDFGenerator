...
<body>
  ...
  <div class="container">
    <div class="left">
      <div class="login">Super Admin Login</div>
      <div class="eula">Welcome to the Super Admin Login Interface where you can monitor the admins of the application</div>
    </div>
    <div class="right">
