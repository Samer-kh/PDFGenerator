...
<div id="droite"> 
		...
		<div class="page-container">
			...
			<h3>Choose the document :</h3>
                 <button type="submit" value="Add" name="submit">Inscription Certificate</button>
                  <button type="submit" value="Add" name="submit">Presence Certificate</button>
                   <button type="submit" value="Add" name="submit">Success Certificate</button>
                    <button type="submit" value="Add" name="submit">Absence Certificate</button>
                <button type="submit" value="Add" name="submit">Departure Certificate</button>
            </form>
        </div>
