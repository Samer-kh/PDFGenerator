...
<title>Super Admin DataTable</title>
        ...
        <c:choose>
				...
				<c:forEach var = "i" begin = "${numPage}" end = "${numPage + 4}">
					<tr>
						...
						<td><c:out value = "${l.get(i).getAdminName()}"/></td>
						<td><c:out value = "${l.get(i).getAdminMDP()}"/></td>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="SuperAdminServletAdd" method="post">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="AdminMDP" required>
					</div>
					</div>
		...
		<div class="modal-content">
			<form action="SuperAdminServletUpdate" method="post">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						<label>Admin Password :</label>
						<input type="text" class="form-control" value="${l.get(j).getAdminMDP()}" name="AdminMDP" required>
					</div>
...
<div id="deleteEmployeeModal${k}" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="SuperAdminServletRemove" method="post">
				<div class="modal-header">						
...
<div id="deleteEmployeeModalAll" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="SuperAdminServletRemoveAll" method="post">
				<div class="modal-header">						
					<h4 class="modal-title">Delete Admins</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<input type="hidden" name="idR" value="${l.get(k).getAdminName()}" >
				</div>
				<div class="modal-body">					
					<p>Are you sure you want to delete the selected admins(s) ?</p>
					<p class="text-warning"><small>This action cannot be undone.</small></p>
				</div>
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
