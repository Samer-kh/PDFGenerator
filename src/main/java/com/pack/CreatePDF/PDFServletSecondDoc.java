		...
		// TODO Auto-generated method stub
		 Document document = new Document();
	      try
	      {
	         ...
	         Paragraph title=new Paragraph("\n\nACertificat D'inscription", FontFactory.getFont(FontFactory.TIMES_ROMAN, 20, Font.ITALIC));
	         ...
	         String Parag = " La direction de l'ENSI affirme que l'etudiant(e) " + FName + " " + LName + " de carte d'identité " + CIN + " ayant le numéro d'inscription " + InscID +" , est inscrit à l'ENSI Pour l'année universitaire 2019/2020 ou il/elle est entrain de poursuivre ces études en ingénieurie d'informatique le long de l'année " ;
